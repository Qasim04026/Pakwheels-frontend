    ...
    <div className='flex flex-col h-auto py-10'>
      ...
      <footer className='flex flex-col h-auto py-4'>
        <div className='flex flex-row justify-center gap-1'>
          <a href="https://www.facebook.com/qasim.raza.7564129" target='blank' rel='nofollow noopener'>
            <img src='https://cdn-icons-png.flaticon.com/128/5968/5968764.png' alt='facebook logo' />
          </a>
          <a href="https://www.linkedin.com/in/qasim-raza-761104267?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app" target='blank' rel='nofollow noopener'>
