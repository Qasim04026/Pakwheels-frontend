    ...
    return (
        <div>
            <div className="bg-white">
                <h1 className="text-3xl font-bold text-blue-800 text-center  pt-4">Toyota Land Cruiser 2024 Price in Pakistan, Pictures & Reviews</h1>
            </div>
